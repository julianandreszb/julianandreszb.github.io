...
<template>
  ...
  <div id="aboutMe" class="h-full relative">
    <main v-if="!isPageLoading" class="h-full relative">
      ...
      <div
        id="socialMediaMenu"
        class="fixed w-20 h-1/4 bg-dark-blue left-0 bottom-0"
      >
        <ul
          class="invisible md:visible flex flex-col items-center justify-center gap-y-5 mt-5"
        >
          <li>
            <svg
